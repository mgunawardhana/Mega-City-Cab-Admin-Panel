...
function GeneralAdvertisementApproveComp({ toggleModal, isOpen, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default GeneralAdvertisementApproveComp;
